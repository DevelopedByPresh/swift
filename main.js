const track_no = document.querySelector('#input')
var val = document.querySelector('.val')


function Redirect(){

  if(track_no.value === 'TRK-669927392'){
   setTimeout(function () { window.location = "myTracking.html" }, 1);
  }
  


   else if(track_no.value === 'TRK-578283856'){
   ...
   else if(track_no.value === 'TRK-5689682927'){
   ...
   else if(track_no.value === 'TRK-5462728362'){
